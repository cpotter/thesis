...
\begin{tikzpicture}
\umlClass[box=, reference=Shape,]{Shape}{
  \umlAttribute[visibility= public, type= Vector]{Position}
  \umlAttribute[visibility= public, type= Vector]{Hit Position}
  \umlAttribute[visibility= public, type= Material]{Material}
  \umlAttribute[visibility= public, type= float]{Distance}
}
{%
  \umlMethod[visibility= public, returntype= bool]{intersect}{}
  \umlMethod[visibility=-, returntype=Color]{rtnColor}{}
  \umlMethod[visibility= private, returntype = void]{calcNormal}{}
}
\end{tikzpicture}
