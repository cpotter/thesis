...
//Name: sphereMats.ma
//Last modified: Fri, Jan 17, 2014 02:56:52 PM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.912148600558405 3.4020942211277303 56.640123152318637 ;
	setAttr ".r" -type "double3" -3.3383527296024309 13.800000000000011 -5.1173321677504452e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 58.422818097754067;
...
createNode transform -n "pCube1";
	setAttr ".s" -type "double3" 16.797700033974881 16.797700033974881 16.797700033974881 ;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 0 0 32.926986182215273 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ovr" 1.3;
	setAttr ".ncp" 0.01;
	setAttr ".coi" 37.926986182215273;
	setAttr ".ow" 30;
...
createNode transform -n "pSphere1";
	setAttr ".s" -type "double3" 4.7015458144405899 4.7015458144405899 4.7015458144405899 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -2.6435547025393102 6.5328075513259991 10 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode transform -n "pSphere2";
	setAttr ".t" -type "double3" -3.5885833112670658 0 0 ;
	setAttr ".s" -type "double3" 2.6544400079228576 2.6544400079228576 2.6544400079228576 ;
...
createNode transform -n "pSphere3";
	setAttr ".t" -type "double3" 3.7749593767716796 0 0 ;
	setAttr ".s" -type "double3" 2.654 2.654 2.654 ;
...
createNode lambert -n "lambert2";
	setAttr ".c" -type "float3" 0.94499999 0.94499999 0.94499999 ;
...
createNode lambert -n "lambert3";
	setAttr ".c" -type "float3" 0.73500001 0.26768112 0.24549 ;
...
createNode lambert -n "lambert4";
	setAttr ".c" -type "float3" 0.10749999 0.22721252 0.5 ;
...
createNode phong -n "phong2";
	setAttr ".dc" 0.98346000909805298;
	setAttr ".c" -type "float3" 0.27599999 0.5 0.47834665 ;
	setAttr ".rfl" 0;
	setAttr ".cp" 100;
...
createNode displayLayer -n "onesphere";
	setAttr ".c" 1;
	setAttr ".do" 1;
...
createNode polySoftEdge -n "polySoftEdge1";
	...
	setAttr ".ix" -type "matrix" 2.6544400079228576 0 0 0 0 2.6544400079228576 0 0 0 0 2.6544400079228576 0
		 -3.5885833112670658 0 0 1;
	setAttr ".a" 180;
createNode polySoftEdge -n "polySoftEdge2";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[*]";
	setAttr ".ix" -type "matrix" 2.6539999999999999 0 0 0 0 2.6539999999999999 0 0 0 0 2.6539999999999999 0
		 3.7749593767716796 0 0 1;
	setAttr ".a" 180;
createNode lambert -n "lambert7";
	setAttr ".c" -type "float3" 0.37855202 0.5 0.21799999 ;
	setAttr ".ambc" -type "float3" 0.00047999999 0.00047999999 0.00047999999 ;
createNode displayLayer -n "twosphere";
	setAttr ".v" no;
	setAttr ".c" 2;
	setAttr ".do" 2;
createNode blinn -n "blinn1";
	setAttr ".c" -type "float3" 0.20750001 0.5 0.29983252 ;
	setAttr ".rfl" 0;
	setAttr ".ec" 0.16527999937534332;
	setAttr ".sro" 1;
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "onesphere.di" "pSphere1.do";
connectAttr "polySphere1.out" "pSphereShape1.i";
connectAttr "twosphere.di" "pSphere2.do";
connectAttr "polySoftEdge1.out" "pSphereShape2.i";
connectAttr "twosphere.di" "pSphere3.do";
connectAttr "polySoftEdge2.out" "pSphereShape3.i";
...
connectAttr "phong2.oc" "phong1SG.ss";
...
connectAttr "layerManager.dli[1]" "onesphere.id";
connectAttr "lambert7.oc" "lambert6SG.ss";
connectAttr "pSphereShape2.iog" "lambert6SG.dsm" -na;
connectAttr "pSphereShape3.iog" "lambert6SG.dsm" -na;
connectAttr "lambert6SG.msg" "materialInfo6.sg";
connectAttr "lambert7.msg" "materialInfo6.m";
connectAttr "polySphere2.out" "polySoftEdge1.ip";
connectAttr "pSphereShape2.wm" "polySoftEdge1.mp";
connectAttr "polySphere3.out" "polySoftEdge2.ip";
connectAttr "pSphereShape3.wm" "polySoftEdge2.mp";
connectAttr "layerManager.dli[2]" "twosphere.id";
